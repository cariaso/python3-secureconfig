...
class TestCryptKeeper(unittest.TestCase):
    ...
    def test_clean_key(self):
        key_with_whitespace = "\n" + TEST_KEYSTRING + "  "
        self.assertEqual(self.string_ck._clean_key(key_with_whitespace), TEST_KEYSTRING)
